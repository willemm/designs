...
{
    difference() {
        mounting_block(sizey=25, sizex=40, botlip=35, depth=30, lbl="RT", mir=1, extra=15, ebot=15);
        mounting_screw(30, 63, -3, 3.9);
        mounting_screw(30, 10, -25, 3.9);
        mounting_screw(30, 10, 12, 5, 3);
    }
}
...
module mount_lb()
{
    translate([40, 0, 0]) difference() {
        mounting_block(sizey=80, botlip=-9, depth=15, lbl="LB");
        mounting_screw(30, 10, 70, 5, 3);
        mounting_screw(30, 30, 50, 5, 3);
        soff = 1.5;
        ang = atan(soff/40);
        #rotate([0,ang,0]) rotate([0,-90,0]) translate([-soff,0,-1]) linear_extrude(height=42, convexity=8) polygon([
            [-6,0.1],[-6,-15.1],[-10.1,-15.1], [-9, -14], [-9, 0.1]
        ]);
    }
}
        ...
        difference() {
            union() {
                difference() {
                    ...
                    translate([10.2,4.9,sizex-clipwid+extra-0.3]) cube([10,8,0.3]);
                    if (ebot > 0) {
